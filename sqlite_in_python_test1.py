...
cursor.execute('''CREATE TABLE recipes(？,？,？,？,？,？,？,？,？)‘’’,(recipe_code,recipe_descr,recipe_type,recipe_type_descr,ingr_code,ingr_descr,ingr_fraction,ingr_fraction_type,ingr_fraction_type_descr))
